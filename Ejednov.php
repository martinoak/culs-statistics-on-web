...
?>
<script>
function otev(){vzor = window.open("Ejednov.png","vzor","width=700, height=400");}
...
<td><br><h2>One-sample t-test (Student) two-tailed:</h2></td>
...
<?php 
  if ($so==0):?> 
    <br> <font color=red> the variance equels to 0, this test cannot be used </font>
  <?php 
  else:
  ...
  <?php 
    if(Max($t,-$t)>=$inv): ?> 
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; hypothesis &nbsp;&nbsp; H<sub>0</sub> : &mu; = <?php echo($aa);?> &nbsp;&nbsp; is rejected
    <?php 
    else: ?> 
      |T| < t<sub><?php echo($sv)?></sub> <?php echo("(0.975)");?> 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; hypothesis &nbsp;&nbsp; H<sub>0</sub> : &mu; = <?php echo($aa);?> &nbsp;&nbsp; is not rejected
    <?php 
    endif; ?>
