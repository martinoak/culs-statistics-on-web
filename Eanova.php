...
<script>
function otev(){vzor = window.open("Eanova.png","vzor","width=850, height=500");}
...
<td><br><h2> One-way analysis of variance (ANOVA):</h2></td>
...
if($in<3||$in>10||!(round($in)==$in)):    ?>  
  ...
  <?php echo("<font color=red> you did not enter an integer between 3 and 10, correct </font>");
    ...
    <form method=get> test level &nbsp;&nbsp; &alpha; = 0,05 
    <br>  number of classes  &nbsp;&nbsp; r: &nbsp; 
    <input type=integer size=1 name=in value="<?echo($in);?>"> 
    <input type=submit value="yes">  &nbsp; (enter an integer from 3 to 10)
    <br> range of classes &nbsp;&nbsp; n<sub>1</sub>, ..., n<sub><?php echo($in);?></sub>:&nbsp;
    <?php for ($i =0; $i <$in; $i++): ?>
...
echo("<font color=red> you did not enter integers between 2 and 10, correct </font>");
  ...
  <br>  number of categories  &nbsp;&nbsp; r: &nbsp;
    ...
    <input type=submit value="yes"> &nbsp; (enter integers from 2 to 10)
    <br> random samples from &nbsp;N(&mu;<sub>1</sub>, &sigma;&sup2;) ,...,  N(&mu;<sub><?php echo($in);?></sub>, &sigma;&sup2;),   
...
&nbsp;&nbsp;&nbsp;&nbsp;&Sigma; &alpha;<sub>k</sub> = 0
    ...
    null hypothesis &nbsp;&nbsp; H<sub>0</sub>: &mu;<sub>1</sub> = ... = &mu;<sub><?php echo($in);?></sub>
&nbsp;&nbsp;&nbsp; or &nbsp;&nbsp;&nbsp;&alpha;<sub>1</sub> = ... = &alpha;<sub><?php echo($in);?></sub> = 0
    <br>
...
<?php  if ($ss==0):?> 
    <br> <font color=red> residual sums of squares is equal to 0, this test cannot be used </font>
  <?php 
  else:  
$ff=$sa/$fa/$ss; 
$zf=zaokr($ff,3);
...
F<sub><?php echo($fa.",".$fe)?></sub> <?php echo("(0.95) = ".$finv);?>
  ...
  <?php 
    if($ff>=$finv): ?>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        hypothesis &nbsp;&nbsp; H<sub>0</sub> : &alpha;<sub>1</sub> = ... = &alpha;<sub><?php echo($in); ?></sub> = 0  
         &nbsp;&nbsp; is rejected

<br> &nbsp;&nbsp;&nbsp;&nbsp; post hoc test (Sheffé method):&nbsp;&nbsp;&nbsp;&nbsp; 
<br>    
<?php for ($i =0; $i <$in; $i++):
  for ($k =$i+1; $k <$in; $k++): 
if($roz[$i][$k] > $shef[$i][$k]):?>
...
<br><br>
<?php
echo'<a href="Ekruskalwal.php?in=',$in,'&';
for ($i =0; $i <$in; $i++):  
...
echo'a=2"> Kruskal - Wallis test </a>';
?>
