...
<head>
    ...
    <title>Wilcoxonův dvouvýběrový test</title>
...
?>
    ...
    <script>
        function otev() {
            vzor = window.open("wildvou.png", "vzor", "width=750, height=250");
        }
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 mb-6">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                <div>
                    ...
                    <p class="text-slate-400 text-sm mt-1">(Mannův - Whitneyův test)</p>
                </div>
            ...
            <form method="get" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <span class="text-slate-400 text-sm">(zadejte čísla od 4 do 30)</span>
                    </div>
                </div>
...
?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8">
            ...
            <div class="error-box mt-4">
                <p class="text-red-300 font-medium">⚠️ Nezadali jste celá čísla mezi 4 a 30, opravte</p>
            </div>
        </div>
<?php
        break;
            ...
            <form method="get" class="space-y-6">
                ...
                <div>
                    <label class="block text-slate-300 mb-3">
                        Náhodný výběr ze spojitého rozdělení &nbsp;&nbsp; X<sub>1</sub>,...,X<sub><?= $m ?></sub>:
                    </label>
                ...
                <div>
                    <label class="block text-slate-300 mb-3">
                        Náhodný výběr ze spojitého rozdělení &nbsp;&nbsp; Y<sub>1</sub>,...,Y<sub><?= $n ?></sub>:
                    </label>
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2">
                        <?php for ($i = 0; $i < $n; $i++): ?>
                ...
                <div>
                    <label class="block text-slate-300 mb-2">
                        Nulová hypotéza &nbsp;&nbsp; H<sub>0</sub> : rozdělení X<sub>k</sub> a Y<sub>k</sub> jsou stejná
                    </label>
                </div>
...
?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 mb-6">
            <form method="get" class="space-y-6">
                ...
                <div>
                    <label class="block text-slate-300 mb-3">
                        Náhodný výběr ze spojitého rozdělení &nbsp;&nbsp; X<sub>1</sub>,...,X<sub><?php echo($m);?></sub>:
                    </label>
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2">
                        <?php for ($i = 0; $i < $m; $i++): ?>
                            <input type="number" step="any" name="x[]" class="input-field text-center"
                ...
                <div>
                    <label class="block text-slate-300 mb-3">
                        Náhodný výběr ze spojitého rozdělení &nbsp;&nbsp; Y<sub>1</sub>,...,Y<sub><?php echo($n);?></sub>:
                    </label>
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2">
                        <?php for ($i = 0; $i < $n; $i++): ?>
                            <input type="number" step="any" name="y[]" class="input-field text-center"
            ...
            <div class="mt-6 space-y-4">
                ...
                <div class="result-box">
                    <h3 class="text-white font-semibold mb-3">📊 Výběr X s pořadími:</h3>
                ...
                <!-- Y Sample Table -->
                <div class="result-box">
                    <h3 class="text-white font-semibold mb-3">📊 Výběr Y s pořadími:</h3>
                    <div class="data-table overflow-x-auto">
                        <table>
                            <tr>
                    ...
                    <div class="text-blue-100">
                        <?php if ($min < $inv): ?>
                            ...
                            <p class="text-lg font-semibold text-red-300">
                                → Hypotézu H<sub>0</sub> : rozdělení X<sub>k</sub> a Y<sub>k</sub> jsou stejná <strong>zamítneme</strong>
                            </p>
                        <?php else: ?>
                            <p class="mb-2">
                                <span class="font-mono">min(U<sub>1</sub>,U<sub>2</sub>) &gt; k<sub><?php echo($m.",".$n)?></sub></span>
                            ...
                            <p class="text-lg font-semibold text-green-300">
                                → Hypotézu H<sub>0</sub> : rozdělení X<sub>k</sub> a Y<sub>k</sub> jsou stejná <strong>nezamítneme</strong>
                            </p>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 mb-6">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                echo 'a=1" class="link-button">Dvouvýběrový F-test (Fisherův)</a>';
                ?>
            </div>
        </div>
