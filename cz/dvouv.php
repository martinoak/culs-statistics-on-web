...
<head>
    ...
    <title>Dvouvýběrový t-test (Studentův)</title>
...
?>
    ...
    <script>
        function otev() {
            vzor = window.open("img/dvouv.png", "vzor", "width=750, height=300");
        }
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8">
            <form method="get" class="space-y-6">
                ...
                <div class="warning-box">
                    <p class="text-orange-300 font-medium">⚠️ Test lze použít pouze za předpokladu σ<sub>1</sub>² = σ<sub>2</sub>²</p>
                </div>
...
?>
            ...
            <div class="mt-6 space-y-4">
                ...
                ?>
                    ...
                    <?php if ($f <= $finv2 || $f >= $finv3): ?>
                        <div class="error-box">
                            <p class="text-red-300 font-medium">⚠️ Rozptyly se nerovnají, tento test není pro tento případ vhodný</p>
                        </div>
                    <?php endif; ?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 mb-6">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                echo 'a=1" class="link-button">Dvouvýběrový F-test (Fischerův)</a>';
                ?>
