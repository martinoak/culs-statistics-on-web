...
<head>
    ...
    <title>One-sample t-test (Student) one-tailed</title>
 ...
 */
function invt2(int $sv): float
{
    $stud = fopen("../samples/stud/stud1.txt", "r");
    $position = ($sv - 1) * 7;
    fseek($stud, $position);
    $inv = fread($stud, 5);
    fclose($stud);
...
?>
    ...
    <script>
        function otev() {
            vzor = window.open("img/Ejednovjedn.png", "vzor", "width=700, height=400");
        }
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                <div>
                    ...
                    <h1 class="text-2xl md:text-3xl font-bold text-white">
                        One-sample t-test (Student) one-tailed
                    </h1>
                </div>
            ...
            <form method="get" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <span class="text-slate-400 text-sm">(enter an integer from 2 to 30)</span>
                    </div>
                </div>
...
?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8">
            ...
            <div class="error-box mt-4">
                <p class="text-red-300 font-medium">⚠️ You did not enter an integer between 2 and 30, correct</p>
            </div>
        </div>
<?php
        break;
            ...
            <form method="get" class="space-y-6">
                ...
                <div>
                    <label class="block text-slate-300 mb-3">
                        Random sample from N(μ, σ²) &nbsp;&nbsp; X<sub>1</sub>,...,X<sub><?= $n ?></sub>:
                    </label>
...
<?php break;
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 mb-6">
            <form method="get" class="space-y-6">
                ...
                <div>
                    <label class="block text-slate-300 mb-3">
                        Random sample from N(μ, σ²) &nbsp;&nbsp; X<sub>1</sub>,...,X<sub><?php echo($n);?></sub>:
                    </label>
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2">
                        <?php for ($i = 0; $i < $n; $i++): ?>
                            <input type="number" step="any" name="x[]" class="input-field text-center"
            ...
            <div class="mt-6 space-y-4">
                ...
                <div class="result-box">
                    ...
                    <div class="grid md:grid-cols-2 gap-4 text-blue-100">
                        ...
                        <div>
                            <span class="text-slate-300">Sample variance:</span>
                ...
                <?php if ($zso==0): ?>
                    <div class="error-box">
                        <p class="text-red-300 font-medium">⚠️ The variance equals to 0, this test cannot be used</p>
                    </div>
                <?php else:
                ...
                ?>
                    <?php if($c==1): ?>
                        <div class="result-box">
                            ...
                            <div class="grid md:grid-cols-2 gap-4 text-blue-100">
                                <div>
                                    ...
                                    <span class="font-mono text-lg ml-2"><?php echo($zt);?></span>
                                </div>
                                <div>
                                    <span class="text-slate-300">t<sub><?php echo($sv)?></sub>(0.95) =</span>
                                    <span class="font-mono text-lg ml-2"><?php echo($inv);?></span>
                                </div>
                            </div>
                        </div>

                        <div class="result-box <?php echo($t>=$inv ? 'border-red-400' : 'border-green-400');?>">
                            <h3 class="text-white font-semibold mb-3">✓ Test conclusion:</h3>
                            <div class="text-blue-100">
                                <?php if($t>=$inv): ?>
                                    <p class="mb-2">
                                        <span class="font-mono">T ≥ t<sub><?php echo($sv)?></sub>(0.95)</span>
                                    </p>
                                    <p class="text-lg font-semibold text-red-300">
                                        → Hypothesis H<sub>0</sub> : μ ≤ <?php echo($aa);?> <strong>is rejected</strong>
                                    </p>
                                <?php else: ?>
                                    <p class="mb-2">
                                        <span class="font-mono">T &lt; t<sub><?php echo($sv)?></sub>(0.95)</span>
                                    ...
                                    <p class="text-lg font-semibold text-green-300">
                                        → Hypothesis H<sub>0</sub> : μ ≤ <?php echo($aa);?> <strong>is not rejected</strong>
                                    </p>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="result-box">
                            <h3 class="text-white font-semibold mb-2">📈 Confidence interval (95%):</h3>
                    ...
                    <?php elseif($c==2): ?>
                        <div class="result-box">
                            ...
                            <div class="grid md:grid-cols-2 gap-4 text-blue-100">
                                ...
                                <div>
                                    <span class="text-slate-300">t<sub><?php echo($sv)?></sub>(0.05) =</span>
                                    <span class="font-mono text-lg ml-2">-<?php echo($inv);?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="result-box <?php echo($t<=-$inv ? 'border-red-400' : 'border-green-400');?>">
                            ...
                            <div class="text-blue-100">
                                <?php if($t<=-$inv): ?>
                                    <p class="mb-2">
                                        <span class="font-mono">T ≤ t<sub><?php echo($sv)?></sub>(0.05)</span>
                                    </p>
                                    <p class="text-lg font-semibold text-red-300">
                                        → Hypothesis H<sub>0</sub> : μ ≥ <?php echo($aa);?> <strong>is rejected</strong>
                                    </p>
                    ...
                    <?php else: ?>
                        <div class="error-box">
                            <p class="text-red-300 font-medium">⚠️ You did not enter inequality in one-tailed test</p>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 mb-6">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                echo'aa=',$aa,'& a=1" class="link-button">Wilcoxon signed-rank test</a>';
                ?>
            </div>
        </div>
