...
?>
    ...
    <script>
        function otev() {
            vzor = window.open("img/Ereg.png", "vzor", "width=800, height=550");
        }
...
?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8">
            <form method="get" class="space-y-4">
                ...
                <div class="error-box">
                    <strong>⚠️ Error:</strong> You did not enter an integer between 3 and 30, correct
                </div>
                <input type="hidden" name="a" value="1">
            </form>
        </div>
            ...
            <form method="get" class="space-y-6">
                ...
                <div>
                    <label class="block text-slate-300 mb-2">
                        Explanatory variable and random variable of response variable from normal distribution:
                    </label>
                ...
                <div>
                    <label class="block text-white mb-3">Type of regression:</label>
                    <div class="space-y-2">
...
?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 mb-6">
            ...
            <div class="mt-8 result-box">
                <h3 class="text-white font-semibold mb-3">📊 Basic statistics:</h3>
...
?>
            <div class="mt-4 error-box">
                <strong>⚠️ Error:</strong> At least one variance is equal to 0, regression cannot be used
            </div>
<?php
                else:
                    $aaa = $sxy / $so1;
...
?>
            ...
            <div class="mt-4 space-y-4">
                <div class="result-box">
                    <h3 class="text-white font-semibold mb-3">📈 Regression equation:</h3>
                ...
                <div class="result-box">
                    <h3 class="text-white font-semibold mb-3">🔍 Confidence intervals (95%):</h3>
                    <div class="space-y-2 text-blue-100">
                        <p>
                            <span class="text-slate-300">Slope:</span>
                            <span class="font-mono ml-2"><?= $zaaa ?> ± <?= $zaeps ?></span>
                        </p>
                        <p>
                            <span class="text-slate-300">Intercept:</span>
                            <span class="font-mono ml-2"><?= $zbbb ?> ± <?= $zbeps ?></span>
                        </p>
                        <p>
                            <span class="text-slate-300">Expected value for x<sub>0</sub> = <?= $aa ?>:</span>
                ...
                <div class="result-box">
                    <h3 class="text-white font-semibold mb-3">📊 Coefficient of determination:</h3>
...
?>
            ...
            <div class="mt-4 result-box">
                <h3 class="text-white font-semibold mb-3">📉 Regression plot:</h3>
                <img src="data/image.png" alt="Regression plot" class="max-w-full h-auto">
                <p class="text-slate-400 text-sm mt-2">
                    Warning: The browser Explorer usually does not load the restored image, it is necessary to update the web-site (on the toolbar or by key F5)
                </p>
            </div>
...
?>
            ...
            <div class="mt-4 space-y-4">
                ...
                <div class="result-box">
                    <h3 class="text-white font-semibold mb-3">🔍 Slope:</h3>
                ...
                <div class="result-box">
                    <h3 class="text-white font-semibold mb-3">📊 Expected value:</h3>
                    <p class="text-blue-100">
                        For x<sub>0</sub> = <?= $aa ?>: <span class="font-mono"><?= $zyoo ?></span>
                    </p>
                </div>
            </div>
...
?>
            <div class="mt-4 error-box">
                <strong>⚠️ Error:</strong> You did not enter the type of regression
            </div>
<?php
            endif;
?>
            ...
            <div class="mt-6 result-box">
                <h3 class="text-white font-semibold mb-3">🔗 Related tests:</h3>
                <div class="flex flex-wrap gap-3">
                    <a href="Epears.php?n=<?= $n ?>&<?php
                        for ($i = 0; $i < $n; $i++) {
                            echo 'x%5B%5D=' . $x[$i] . '&';
                        }
                        for ($j = 0; $j < $n; $j++) {
