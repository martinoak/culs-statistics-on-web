...
<head>
    ...
    <title>Wilcoxonův jednovýběrový test</title>
...
?>
    ...
    <script>
        function otev() {
            vzor = window.open("img/wiljedn.png", "vzor", "width=650, height=250");
        }
            ...
            <form method="get" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <span class="text-slate-400 text-sm">(zadejte číslo od 6 do 30)</span>
                    </div>
                </div>
...
?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8">
            ...
            <div class="error-box mt-4">
                <p class="text-red-300 font-medium">⚠️ Nezadali jste celé číslo mezi 6 a 30, opravte</p>
            </div>
        </div>
<?php
        break;
            ...
            <form method="get" class="space-y-6">
                ...
                <div>
                    <label class="block text-slate-300 mb-3">
                        Náhodný výběr ze spojitého rozdělení &nbsp;&nbsp; X<sub>1</sub>,...,X<sub><?= $n ?></sub>:
                    </label>
                ...
                <div>
                    <label class="block text-slate-300 mb-2">
                        Nulová hypotéza &nbsp;&nbsp; H<sub>0</sub> : rozdělení symetrické kolem
                    </label>
                    <div class="flex flex-wrap items-center gap-3">
...
?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 mb-6">
            <form method="get" class="space-y-6">
                ...
                <div>
                    <label class="block text-slate-300 mb-3">
                        Náhodný výběr ze spojitého rozdělení &nbsp;&nbsp; X<sub>1</sub>,...,X<sub><?php echo($n);?></sub>:
                    </label>
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2">
                        <?php for ($i = 0; $i < $n; $i++): ?>
                            <input type="number" step="any" name="x[]" class="input-field text-center"
            ...
            <div class="mt-6 space-y-4">
                ...
                <div class="result-box">
                    <h3 class="text-white font-semibold mb-3">📊 Rozdíly a pořadí:</h3>
                ...
                if($no < 6): ?>
                    <div class="error-box">
                        <p class="text-red-300 font-medium">⚠️ Počet nenulových rozdílů je příliš nízký, tento test nelze užít</p>
                    </div>
                        ...
                        <div class="text-blue-100">
                            <?php if($min < $inv): ?>
                                ...
                                <p class="text-lg font-semibold text-red-300">
                                    → Hypotézu H<sub>0</sub> : rozdělení symetrické kolem <?php echo($aa);?> <strong>zamítneme</strong>
                                </p>
                            <?php else: ?>
                                <p class="mb-2">
                                    <span class="font-mono">min(S<sup>+</sup>,S<sup>-</sup>) &gt; k<sub><?php echo($no)?></sub></span>
                                ...
                                <p class="text-lg font-semibold text-green-300">
                                    → Hypotézu H<sub>0</sub> : rozdělení symetrické kolem <?php echo($aa);?> <strong>nezamítneme</strong>
                                </p>
                            <?php endif; ?>
                        </div>
                    </div>
