...
<head>
    ...
    <title>Dvojné třídění (ANOVA) s interakcemi</title>
...
?>
    ...
    <script>
        function otev() {
            vzor = window.open("anovadvouinter.png", "vzor", "width=950, height=700");
        }
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                <div>
                    ...
                    <h1 class="text-2xl md:text-3xl font-bold text-white">
                        Dvojné třídění (ANOVA) s interakcemi
                    </h1>
                </div>
...
<?php if ($ffab >= $finvab): ?>
            <div class="success-box">
                ...
                <p class="text-green-300 mt-2">→ Hypotézu H<sub>0</sub>: γ<sub>1,1</sub> = ... = γ<sub><?php echo $ir; ?>,<?php echo $is; ?></sub> = 0 <strong>zamítneme</strong></p>
            </div>
<?php else: ?>
            <div class="result-box">
                <p class="text-slate-300">F<sub>AB</sub> < F<sub><?php echo $fab . "," . $fe; ?></sub>(0.95)</p>
                <p class="text-slate-300 mt-2">→ Hypotézu H<sub>0</sub>: γ<sub>1,1</sub> = ... = γ<sub><?php echo $ir; ?>,<?php echo $is; ?></sub> = 0 <strong>nezamítneme</strong></p>
            </div>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <div class="mt-6">
                ...
                <div class="flex flex-wrap gap-3">
                    <a href="anovadvoj.php?ir=<?php echo $ir; ?>&is=<?php echo $is; ?>&ip=<?php echo $ip; ?>&<?php
                        for ($i = 0; $i < $ir; $i++) {
                            for ($k = 0; $k < $is; $k++) {
                                for ($j = 0; $j < $ip; $j++) {
                    ...
                    ?>a=1" class="link-button">Dvojné třídění (ANOVA) bez interakcí</a>
                </div>
            </div>
        </div>
