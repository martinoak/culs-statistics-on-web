...
?>
    ...
    <script>
        function otev() {
            vzor = window.open("img/parovy.png", "vzor", "width=750, height=450");
        }
...
?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8">
            <form method="get" class="space-y-6">
                ...
                <div>
                    <label class="block text-slate-300 mb-2">
                        Nulová hypotéza &nbsp;&nbsp; H<sub>0</sub> : μ<sub>1</sub> = μ<sub>2</sub>
                    </label>
                </div>
...
?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 mb-6">
            <form method="get" class="space-y-6">
                ...
                <div>
                    <label class="block text-slate-300 mb-3">
                        Náhodný výběr z normálního rozdělení &nbsp;&nbsp; (X<sub>1</sub>,Y<sub>1</sub>),...,(X<sub><?php echo($n);?></sub>,Y<sub><?php echo($n);?></sub>)
                    </label>
                </div>

                <div>
                    <label class="block text-slate-300 mb-3">
                        X<sub>1</sub>,...,X<sub><?php echo($n);?></sub>:
                    </label>
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2">
                        <?php for ($i = 0; $i < $n; $i++): ?>
                            <input type="number" step="any" name="x[]" class="input-field text-center"
                ...
                <div>
                    <label class="block text-slate-300 mb-3">
                        Y<sub>1</sub>,...,Y<sub><?php echo($n);?></sub>:
                    </label>
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2">
                        <?php for ($i = 0; $i < $n; $i++): ?>
                            <input type="number" step="any" name="y[]" class="input-field text-center"
            ...
            <div class="mt-6 space-y-4">
                ...
                <div class="result-box">
                    <h3 class="text-white font-semibold mb-3">📊 Rozdíly Z<sub>i</sub> = X<sub>i</sub> - Y<sub>i</sub>:</h3>
                    <div class="flex flex-wrap gap-2">
                        <?php for ($i = 0; $i < $n; $i++): ?>
                            <span class="text-blue-100 font-mono bg-slate-700/50 px-3 py-1 rounded">
                                <?php echo(zaokr($z[$i], 4));?>
                            </span>
                        <?php endfor; ?>
                    </div>
                </div>
