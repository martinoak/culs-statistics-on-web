...
<head>
    ...
    <title>Jednovýběrový t-test (Studentův) jednostranný</title>
...
?>
    ...
    <script>
        function otev() {
            vzor = window.open("img/jednovjedn.png", "vzor", "width=700, height=400");
        }
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                <div>
                    ...
                    <h1 class="text-2xl md:text-3xl font-bold text-white">
                        Jednovýběrový t-test (Studentův) jednostranný
                    </h1>
                </div>
            ...
            <form method="get" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <span class="text-slate-400 text-sm">(zadejte číslo od 2 do 30)</span>
                    </div>
                </div>
...
?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8">
            ...
            <div class="error-box mt-4">
                <p class="text-red-300 font-medium">⚠️ Nezadali jste celé číslo mezi 2 a 30, opravte</p>
            </div>
        </div>
<?php
        break;
...
<?php break;
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 mb-6">
            ...
            <div class="mt-6 space-y-4">
                ...
                <?php if ($zso==0): ?>
                    <div class="error-box">
                        <p class="text-red-300 font-medium">⚠️ Rozptyl se rovná 0, tento test nelze užít</p>
                    </div>
                <?php else:
                ...
                ?>
                            ...
                            <div class="text-blue-100">
                                <?php if($t>=$inv): ?>
                                    ...
                                    <p class="text-lg font-semibold text-red-300">
                                        → Hypotézu H<sub>0</sub> : μ ≤ <?php echo($aa);?> <strong>zamítneme</strong>
                                    </p>
                                <?php else: ?>
                                    <p class="mb-2">
                                        <span class="font-mono">T &lt; t<sub><?php echo($sv)?></sub>(0.95)</span>
                                    ...
                                    <p class="text-lg font-semibold text-green-300">
                                        → Hypotézu H<sub>0</sub> : μ ≤ <?php echo($aa);?> <strong>nezamítneme</strong>
                                    </p>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <?php else: ?>
                        <div class="error-box">
                            <p class="text-red-300 font-medium">⚠️ Nezadali jste nerovnost v jednostranném testu</p>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 mb-6">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                echo'aa=',$aa,'& a=1" class="link-button">Jednovýběrový test pro rozptyl</a>';
                ?>
