...
<head>
    ...
    <title>One-sample test for variance</title>
...
?>
    ...
    <script>
        function otev() {
            vzor = window.open("img/EjednovS.png", "vzor", "width=700, height=400");
        }
...
?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8">
            <form method="get" class="space-y-6">
                ...
                <div>
                    <label class="block text-slate-300 mb-2">
                        Null hypothesis &nbsp;&nbsp; H<sub>0</sub> : σ² =
                    </label>
                    <div class="flex flex-wrap items-center gap-3">
                        <input type="number" step="any" class="input-field w-32" name="aa" value="<?= $aa ?? '' ?>" placeholder="value">
                        <span class="text-slate-400 text-sm">(enter positive number)</span>
                    </div>
                </div>
...
elseif($aa<=0): ?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8">
            ...
            <div class="error-box mt-4">
                <p class="text-red-300 font-medium">⚠️ You did not enter positive number, correct</p>
            </div>
        </div>
<?php break;
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 mb-6">
            ...
            <div class="mt-6 space-y-4">
                    ...
                    <div class="text-blue-100">
                        <?php if($v<=$inv1||$v>=$inv2): ?>
                            ...
                            <p class="text-lg font-semibold text-red-300">
                                → Hypothesis H<sub>0</sub> : σ² = <?php echo($aa);?> <strong>is rejected</strong>
                            </p>
                        <?php else: ?>
                            <p class="mb-2">
                            ...
                            <p class="text-lg font-semibold text-green-300">
                                → Hypothesis H<sub>0</sub> : σ² = <?php echo($aa);?> <strong>is not rejected</strong>
                            </p>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="result-box">
                    <h3 class="text-white font-semibold mb-2">📈 Interval of confidence (95%):</h3>
