...
<head>
    ...
    <title>Two-sample F-test (Fisher)</title>
...
?>
    ...
    <script>
        function otev() {
            vzor = window.open("EdvouvF.png", "vzor", "width=750, height=300");
        }
...
?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8">
            <form method="get" class="space-y-6">
                ...
                <div>
                    <label class="block text-slate-300 mb-2">
                        Null hypothesis &nbsp;&nbsp; H<sub>0</sub> : σ<sub>1</sub> = σ<sub>2</sub>
                    </label>
                </div>
...
?>
                    ...
                    <div class="result-box <?php echo(($f <= $finv2 || $f >= $finv3) ? 'border-red-400' : 'border-green-400');?>">
                        ...
                        <div class="text-blue-100">
                            <?php if ($f <= $finv2 || $f >= $finv3): ?>
                                <p class="mb-2">
                                    <span class="font-mono">F ≤ F<sub><?php echo($sv.",".$sw)?></sub>(0.025) &nbsp;&nbsp; or &nbsp;&nbsp; F ≥ F<sub><?php echo($sv.",".$sw)?></sub>(0.975)</span>
                                </p>
                                <p class="text-lg font-semibold text-red-300">
                                    → Hypothesis H<sub>0</sub> : σ<sub>1</sub> = σ<sub>2</sub> <strong>is rejected</strong>
                                </p>
                            <?php else: ?>
                                <p class="mb-2">
                                ...
                                <p class="text-lg font-semibold text-green-300">
                                    → Hypothesis H<sub>0</sub> : σ<sub>1</sub> = σ<sub>2</sub> <strong>is not rejected</strong>
                                </p>
                            <?php endif; ?>
                        </div>
                    </div>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 mb-6">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                echo 'a=1" class="link-button">Two-sample t-test (Student)</a>';
                ?>
                <?php
