...
?>
    ...
    <script>
        function otev() {
            vzor = window.open("img/Ejednov.png", "vzor", "width=700, height=400");
        }
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                <div>
                    ...
                    <h1 class="text-2xl md:text-3xl font-bold text-white">
                        One-sample t-test (Student) two-tailed
                    </h1>
                </div>
            ...
            <form method="get" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2">
                        <?php for ($i =0; $i <$n; $i++): ?>
                            <input type="number" step="any" name="x[]" class="input-field text-center" value="<?php echo(isset($x[$i]) ? $x[$i] : '');?>" placeholder="X<?php echo($i+1);?>">
                        <?php endfor;?>
                    </div>
                </div>
                ...
                <div>
                    <label class="block text-slate-300 mb-2">
                        Null hypothesis &nbsp;&nbsp; H<sub>0</sub> : μ =
                    </label>
                    <input type="number" step="any" class="input-field w-32" name="aa" value="<?php echo($aa ?? '');?>">
                </div>
