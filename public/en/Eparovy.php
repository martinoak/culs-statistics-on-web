...
<head>
    ...
    <title>Paired t-test (Student)</title>
...
?>
    ...
    <script>
        function otev() {
            vzor = window.open("img/Eparovy.png", "vzor", "width=750, height=450");
        }
...
?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 mb-6">
            <form method="get" class="space-y-6">
                ...
                <div>
                    <label class="block text-slate-300 mb-3">
                        Random sample from normal distribution &nbsp;&nbsp; (X<sub>1</sub>,Y<sub>1</sub>),...,(X<sub><?php echo($n);?></sub>,Y<sub><?php echo($n);?></sub>)
                    </label>
                </div>
