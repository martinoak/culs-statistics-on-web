...
<head>
    ...
    <title>Two-way ANOVA without Interactions</title>
...
?>
    ...
    <script>
        function otev() {
            vzor = window.open("Eanovadvou.png", "vzor", "width=950, height=700");
        }
            ...
            <form method="get" class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-slate-400 text-sm mt-1">From 1 to 10</p>
                    </div>
                </div>
...
<?php if ($ffa >= $finva): ?>
            ...
            <div class="result-box">
                <h3 class="text-lg font-bold text-white mb-3">📊 Post hoc test (Scheffé method) for factor A:</h3>
                        ...
                        for ($k = $i + 1; $k < $ir; $k++):
                            if ($roza[$i][$k] > $shefa): ?>
                                <p>|<span style="text-decoration: overline">X</span><sub><?php echo ($i + 1); ?></sub><sup>A</sup> -
                                   ...
                                   <span class="text-green-300">→ there is a difference</span></p>
                            <?php else: ?>
                                <p>|<span style="text-decoration: overline">X</span><sub><?php echo ($i + 1); ?></sub><sup>A</sup> -
                                   <span style="text-decoration: overline">X</span><sub><?php echo ($k + 1); ?></sub><sup>A</sup>| =
                                   <span class="data-value"><?php echo $zroza[$i][$k]; ?></span> ≤ <?php echo $zshefa; ?>
                                   <span class="text-slate-400">→ no difference</span></p>
                            <?php endif;
                        endfor;
                    endfor; ?>
                </div>
...
<?php if ($ffb >= $finvb): ?>
            ...
            <div class="result-box">
                <h3 class="text-lg font-bold text-white mb-3">📊 Post hoc test (Scheffé method) for factor B:</h3>
                <div class="text-slate-300 space-y-1 text-sm">
                    <?php for ($i = 0; $i < $is; $i++):
                        for ($k = $i + 1; $k < $is; $k++):
                            if ($rozb[$i][$k] > $shefb): ?>
...
<?php endif; ?>
            ...
            <div class="mt-6">
                ...
                <div class="flex flex-wrap gap-3">
                    <a href="Eanovadvojinter.php?ir=<?php echo $ir; ?>&is=<?php echo $is; ?>&ip=<?php echo $ip; ?>&<?php
                        for ($i = 0; $i < $ir; $i++) {
                            for ($k = 0; $k < $is; $k++) {
                                for ($j = 0; $j < $ip; $j++) {
                    ...
                    ?>a=1" class="link-button">Two-way ANOVA with interactions</a>
