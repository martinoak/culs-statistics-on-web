...
<head>
    ...
    <title>Spearman Correlation Coefficient Test</title>
...
?>
    ...
    <script>
        function otev() {
            vzor = window.open("img/Espearmann.png", "vzor", "width=600, height=300");
        }
            ...
            <form method="get" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <span class="text-slate-400 text-sm">(enter an integer from 5 to 30)</span>
                    </div>
                </div>
...
?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8">
            ...
            <div class="error-box mt-4">
                <p class="text-red-300 font-medium">⚠️ You did not enter an integer between 5 and 30, correct</p>
            </div>
        </div>
            ...
            <form method="get" class="space-y-6">
                ...
                <div>
                    <label class="block text-slate-300 mb-3">
                        Random sample from continuous distribution &nbsp;&nbsp; (X<sub>1</sub>,Y<sub>1</sub>),...,(X<sub><?= $n ?></sub>,Y<sub><?= $n ?></sub>)
                    </label>
                ...
                <div class="result-box">
                    <p class="text-blue-100">
                        <strong>Null hypothesis H<sub>0</sub>:</strong> X<sub>k</sub>, Y<sub>k</sub> are independent
                    </p>
                </div>
...
?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 mb-6">
            ...
            <div class="mt-8 space-y-4">
                <div class="result-box">
                    <h3 class="text-white font-semibold mb-4">📊 Data and ranks X:</h3>
                ...
                <div class="result-box">
                    <h3 class="text-white font-semibold mb-4">📊 Data and ranks Y:</h3>
                    <div class="data-table overflow-x-auto">
                        <table>
                            <tr>
                    ...
                    <div class="text-blue-100">
                        <?php if (max($r, -$r) >= $inv): ?>
                            ...
                            <p class="text-lg font-semibold text-red-300">
                                → Hypothesis H<sub>0</sub> : X<sub>k</sub>, Y<sub>k</sub> are independent is <strong>rejected</strong>
                            </p>
                        <?php else: ?>
                            <p class="mb-2">
                                <span class="font-mono">|r<sub>S</sub>| &lt; k<sub><?= $n ?></sub></span>
                            ...
                            <p class="text-lg font-semibold text-green-300">
                                → Hypothesis H<sub>0</sub> : X<sub>k</sub>, Y<sub>k</sub> are independent is <strong>not rejected</strong>
                            </p>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 mb-6">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                echo 'a=1" class="link-button">Pearson correlation coefficient</a>';
                ?>
