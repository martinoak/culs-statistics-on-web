...
?>
    ...
    <script>
        function otev() {
            vzor = window.open("img/Efriedman.png", "vzor", "width=700, height=400");
        }
...
?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8">
            <form method="get" class="space-y-4">
                ...
                <div>
                    <label class="block text-slate-300 mb-2">
                        Number of categories <strong>r:</strong>
                    </label>
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <span class="text-slate-400 text-sm">(enter integers from 2 to 10)</span>
                    </div>
                </div>
...
?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8">
            ...
            <div class="error-box mt-4">
                <p class="text-red-300 font-medium">⚠️ You did not enter required integers, correct</p>
            </div>
        </div>
            ...
            <form method="get" class="space-y-6">
                ...
                <div class="result-box">
                    <p class="text-blue-100">
                        <strong>Null hypothesis H<sub>0</sub>:</strong> distributions of rows are the same
                    </p>
                </div>
...
?>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8 mb-6">
            ...
            <div class="mt-8 space-y-4">
                <div class="result-box">
                    <h3 class="text-white font-semibold mb-4">📊 Data and ranks:</h3>
                    <?php for ($i = 0; $i < $ir; $i++): ?>
                        <table class="data-table mb-4">
                            ...
                            <tr>
                                <td class="text-left rank">Order:</td>
                                <?php for ($k = 0; $k < $is; $k++): ?>
                    ...
                    <div class="text-blue-100">
                        <?php if ($q >= $chinv): ?>
                            ...
                            <p class="text-lg font-semibold text-red-300">
                                → Hypothesis H<sub>0</sub> : the distributions are the same is <strong>rejected</strong>
                            </p>
                        <?php else: ?>
                            <p class="mb-2">
                                <span class="font-mono">Q &lt; χ²<sub><?= ($ir - 1) ?></sub>(0.95)</span>
                            ...
                            <p class="text-lg font-semibold text-green-300">
                                → Hypothesis H<sub>0</sub> : the distributions are the same is <strong>not rejected</strong>
                            </p>
                        <?php endif; ?>
                    </div>
                </div>
