...
<script>
function otev(){vzor = window.open("Eanovadvou.png","vzor","width=950, height=700");}
...
<td><br><h2>Two-way ANOVA without interactions:</h2></td>
...
case 0: ?>
    ...
    <br> number of classes A &nbsp;&nbsp; r: &nbsp; 
    <input type=integer size=1 name=ir value="<?php echo($ir);?>">  
    &nbsp;&nbsp;&nbsp;&nbsp; number of classes B &nbsp;&nbsp; s: &nbsp;
    <input type=integer size=1 name=is value="<?php echo($is);?>"> &nbsp; (enter integers from 2 to 10) ,
    &nbsp;&nbsp;&nbsp;&nbsp; range of classes &nbsp;&nbsp; p: &nbsp;
    <input type=integer size=1 name=ip value="<?php echo($ip);?>">      &nbsp; (enter an integer from 1 to 10)
...
&nbsp;&nbsp;&nbsp;&nbsp;&Sigma; &alpha;<sub>k</sub> = 0 , &nbsp;&nbsp;&nbsp;&Sigma; &beta;<sub>k</sub> = 0
    ...
    null hypotheses &nbsp;&nbsp; H<sub>0</sub>: &alpha;<sub>1</sub> = ... = &alpha;<sub><?php echo($ir);?></sub> = 0
    <br>
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
<?php  if ($zss==0):?> 
    <br> <font color=red> rezidual sum of squares is equal to 0, this test cannot be used </font>
  <?php 
  else:  
...
<br><br>
<?php
echo'<a href="Eanovadvojinter.php?ir=',$ir,'&  is=',$is,'& ip=',$ip,'&';
for ($i =0; $i <$ir; $i++): 
for ($k =0; $k <$is; $k++): 
for ($j =0; $j <$ip; $j++): 
echo'x%5B%5D=',$x[$is*$ip*$i+$ip*$k+$j],'&';
endfor;endfor;endfor;
echo'aa=',$aa,'& a=1"> Two-way ANOVA and interactions </a>';
?>
