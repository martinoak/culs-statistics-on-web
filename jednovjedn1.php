...
?>
<script>
function otev(){vzor = window.open("jednovjedn.png","vzor","width=750, height=550");}
...
<td><br><h2>Jednovýběrový t-test (Studentův) jednostranný:</h2></td>
...
<form method=get> hladina testu &nbsp;&nbsp; &alpha; = 0,05 
  ...
  <?php endfor;?> 
<table>
<tr><td>nulová hypotéza &nbsp;&nbsp; H<sub>0</sub> :</td>
<td><input type="radio" name="c" value=1 <? if($c==1):?> checked <? endif;?>> &mu; &le;</td>
<td rowspan=2><input type=double size=1 name=aa value="<?echo($aa);?>"></td></tr>
<tr><td></td><td><input type="radio" name="c" value=2 <? if($c==2):?> checked <? endif;?>>  &mu; &ge; </td></tr>
</table> 
...
<?php 
  ...
  <?php 
    if($t>=$inv): ?> 
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       hypotézu &nbsp;&nbsp; H<sub>0</sub> : &mu; &le; <?php echo($aa);?> &nbsp;&nbsp;zamítneme
    <?php 
    else: ?> 
      T < t<sub><?php echo($sv)?></sub> <?php echo("(0.95)");?> 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       hypotézu &nbsp;&nbsp; H<sub>0</sub> : &mu; &le; <?php echo($aa);?> &nbsp;&nbsp;nezamítneme
    <?php 
    endif; ?>
  ...
  <?php 
    if($t<=-$inv): ?> 
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       hypotézu &nbsp;&nbsp; H<sub>0</sub> : &mu; &ge; <?php echo($aa);?> &nbsp;&nbsp;zamítneme
    <?php 
    else: ?> 
      T > t<sub><?php echo($sv)?></sub> <?php echo("(0.05)");?> 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       hypotézu &nbsp;&nbsp; H<sub>0</sub> : &mu; &ge; <?php echo($aa);?> &nbsp;&nbsp;nezamítneme
    <?php 
    endif; ?>
    <br><br> konfidenční interval (95%):&nbsp;&nbsp;&nbsp;&nbsp; 
    ...
    <?php else: ?> 
    <br> <font color=red> nezadali jste nerovnost v jednostranném testu </font>
    <? endif; ?> 
<?  endif; ?> 
